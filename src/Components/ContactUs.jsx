...
const ContactUs = () => {
    ...
    const handleSubmission = (e) => {
        ...
        if (data.name && data.email && data.subject && data.message) {
            emailjs.send("service_69bom7b", "template_vbqf0vn", data, "n0GGFqdZKLDxBpOkC")
                .then((response) => {
                    setSubmit(true)
                }).catch((error) => {
                    setSubmit(false)
    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div data-aos='fade-right' style={{ color: "white" }}>
                            ...
                            <a href="tel:+91-7988376352" rel="noreferrer" target="_blank">
                                <p>+91-7988376352</p>
                            </a>
                        </div>
                        <div  data-aos='fade-down' style={{ color: "white" }}>
                            ...
                            <a href='https://www.linkedin.com/in/nitesh-sindhu-150473203/' rel="noreferrer" target="_blank"><p>View on LinkedIn</p></a>
                        </div>
                        <div  data-aos='fade-down' style={{ color: "white" }}>
                            <GitHub fontSize="large"/>
                            <h1>Github</h1>
                            <p>Here is My Github</p>
                            <a href='https://github.com/NiteshSindhu' rel="noreferrer" target="_blank"><p>View on Github</p></a>
                        </div>
                        <div  data-aos='fade-up' style={{ color: "white" }}>
                            <EmailIcon fontSize="large"/>
                            <h1>Email</h1>
                            <p>You can Simply mail me just by clicking on my email</p>
                            <a href='mailto:niteshsindhu1435@gmail.com' rel="noreferrer" target="_blank"><p>niteshsindhu1435@gmail.com</p></a>
                        </div>
                        <div data-aos='fade-left' style={{ color: "white" }}>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Narwana,Haryana</p>
                            <a  href="https://www.google.com/maps/place/Narwana,+Haryana+126116/@29.5970397,76.1009791,14z/data=!3m1!4b1!4m5!3m4!1s0x3911f29168ef86cf:0x4c5ad298bb70a1c3!8m2!3d29.5959853!4d76.1149662"rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2022 Nitesh Sindhu Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
